(function () {
    ...
    var InstallmentReceiptCtrl = function ($scope, InstallmentReceiptService) {
        var ctrl = this;
        ...
        var getTransactionDetails = function (){
            InstallmentReceiptService.getTransactionDetails().then(
                function(response){
    ...
    CFApp.controller('InstallmentReceiptCtrl', ['$scope', 'InstallmentReceiptService', InstallmentReceiptCtrl]);
}());